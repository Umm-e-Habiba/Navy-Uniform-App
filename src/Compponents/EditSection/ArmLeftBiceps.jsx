...
const LeftArmContent = (props) => {
    ...
    const GetCurrentContent = () => {
        ...
        if (
            ...
            let findStar = selectedOptions?.leftBiceps?.find(
                (starItem) => starItem?.badgeKey === "leftChest11"
            );
            let placedItems = selectedOptions?.leftBiceps;

            const getPosition = CurrentLeftBicep(
                currentDresses?.keyName,
                currentDresses?.badgeKey,
                placedItems,
                findStar,
                DressCheck
            );
                                ...
                                return (
                                    <>
                                        <Box
                                            ...
                                            sx={{
                                                position: "relative",
                                                width: findStar ? "0.35rem" : "1.4rem",
                                                height: findStar ? "0.35rem" : "3.4rem",
                                                transform:
